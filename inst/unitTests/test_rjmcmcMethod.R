...
test.rjmcmc_good_result_04 <- function() {
    ...
    exp.qmu     <- matrix(c(18830.2584268975, 18904.7226562500, 18995.6777777778,
                            19121.6120802148, 19288.3044692737, 19373.7389240506,
                            19500.7738853503, 18830.2584268975, 18994.0909090909,
    ...
    exp.qw      <- matrix(c(0.16025522347367316, 0.16551201704162743,
                            0.13885420212346347, 0.00336105883692090,
                            0.00194283644802028, 0.00153109446414591,
                            0.00153109446414591, 0.34791115965936481,
                            0.39397798749258084, 0.26234946924603914,
                            0.10941726309721994, 0.13977379020336750,
                            0.13977379020336750, 0.13977379020336750), nrow = 2)
