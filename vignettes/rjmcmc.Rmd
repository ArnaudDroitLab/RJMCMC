...
it is mandatory to analyse each chromosome separatly since the 
...
of false positives, it is still beneficial for regions rich in nucleosomes.  
...
be efficiant. So, it should not be run on segmented results. The function needs
